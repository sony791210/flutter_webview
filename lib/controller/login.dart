...
//          helperText: 'password',
  ...
  //密码输入框样式
  static Widget buildPasswordTextFiedTest(TextEditingController controller) {
...
//          helperText: 'password',
  ...
  // static Widget buildPasswordTextFiedTest2(TextEditingController controller) {
  //   return
  //     new Container(
  //       child: TextFormField(
  //         decoration: InputDecoration(
  ...
  Widget textSection = new Container(
    ...
    child: new Column(
      ...
      children: <Widget>[
        buildPasswordTextFiedTest(_accountController),
